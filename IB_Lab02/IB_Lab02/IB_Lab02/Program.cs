...
internal class Program
{
    private static void Main(string[] args)
    {
        ...
        Console.WriteLine($"Shannon Entropy (polish): {Entropy.GetShannonEntropy(polish)}");
        Console.WriteLine($"Shannon Entropy (base64): {Entropy.GetShannonEntropy(base64)}");
        Console.WriteLine($"\nHartley Entropy (polish): {Entropy.GetHartleyEntropy(polish)}");
        Console.WriteLine($"Hartley Entropy (base64): {Entropy.GetHartleyEntropy(base64)}");
